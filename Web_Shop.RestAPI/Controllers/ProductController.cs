...
namespace Web_Shop.RestAPI.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        {
            //var result = await _productService.SearchProductsAsync(paginationParams);
        ...
        public async Task<ActionResult<GetSingleProductDTO>> AddProduct([FromBody] AddUpdateProductDTO dto)
        {
            ...
            //return CreatedAtAction(nameof(GetProduct), new { id = result.entity?.IdProduct }, mapper.Map<MapGetSingleProductDTO>(result.entity));
